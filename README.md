![Preview](./data/PFL.png "Particle Filter")
...
## Running the Code
Watch the running version here: http://recordit.co/rnt5tTSYtQ

This project involves the Udacity's Simulator which can be downloaded [here](https://github.com/udacity/self-driving-car-sim/releases)
...
## Success Criteria
If the particle filter passes the current grading code in the simulator:
